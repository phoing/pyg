<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\heima\server\pyg\public/../application/home\view\member\order.html";i:1576320441;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;s:58:"E:\heima\server\pyg\application\home\view\member_left.html";i:1576327474;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="orders">
                                ...
                                <div class="choose-title">
                                    <label data-toggle="checkbox" class="checkbox-pretty ">
                                        <input type="checkbox" checked="checked"><span><?php echo date('Y-m-d H:i:s',$v['create_time']); ?>　订单编号：<?php echo $v['order_sn']; ?>  店铺：哇哈哈 <a>和我联系</a></span>
                                     </label>
									  <a class="sui-btn btn-info share-btn">分享</a>
                                </div>
                                <table class="sui-table table-bordered order-datatable">
                                    <tbody>
                                    <?php foreach($v['order_goods'] as $key => $goods): ?>
                                        <tr>
                                            <td width="35%">
                                                <div class="typographic"><img src="<?php echo $goods['goods_logo']; ?>" />
                                                    <a href="#" class="block-text">包邮 <?php echo $goods['goods_name']; ?> 新款</a>
                                                    <span class="guige">规格：<?php echo $goods['spec_value_names']; ?></span>
                                                </div>
                                            </td>
                                            <td width="5%" class="center">
                                                <ul class="unstyled">
                                                    <li class="o-price">¥<?php echo $goods['goods_price']; ?></li>
                                                    <li>¥<?php echo $goods['goods_price']; ?></li>
                                                </ul>
                                            </td>
                                            <td width="5%" class="center"><?php echo $goods['number']; ?></td>
                                            <td width="8%" class="center">
                                                <ul class="unstyled">
                                                <?php if(($v['order_status']==0 && $goods['status']==0)): ?>
                                                    <li>未发货</li>
                                                    <li><a>退货/退款</a></li>
                                                    <?php elseif((($v['order_status']==1 && $goods['status']==0) || ($v['order_status']==8 && $goods['status']==0))): ?>
                                                    <li>待发货</li>
                                                    <li><a>退货/退款</a></li>
                                                    <?php elseif((($v['order_status']==1 || $v['order_status']==8) && $goods['status']==1)): ?>
                                                    <li>已发货</li>
                                                    <li><a>退货/退款</a></li>
                                            ...
                                            <?php if(($key==0)): ?>
                                            <td width="10%" class="center" rowspan="<?php echo count($v['order_goods']); ?>">
                                                <ul class="unstyled">
                                                    <li>¥<?php echo $v['order_amount']; ?></li>
                                                    <li>（含运费：￥0.00）</li>
                                                </ul>
                                            </td>
                                            <td width="10%" class="center" rowspan="<?php echo count($v['order_goods']); ?>">
                                                <ul class="unstyled">
                                                    ...
                                                    <li>已取消</li>
                                                    <?php elseif(($v['order_status']==6)): ?>
                                                    <li>已退货</li>
                                                    <?php elseif(($v['order_status']==7)): ?>
                                                    <li>已退款</li>
                                                    <?php elseif(($v['order_status']==8)): ?>
                                                    <li>部分发货</li>
                                                    <?php endif; ?>
                                                    <li><a href="<?php echo url('home/member/orderDetail',['id'=>$v['id']]); ?>" class="btn">订单详情 </a></li>
                                                </ul>
                                            </td>
...
<!--                                            </td>-->
                                            <td width="10%" class="center" rowspan="<?php echo count($v['order_goods']); ?>">
                                                <ul class="unstyled">
                                                    ...
                                                    <li>取消订单</li>
                                                    <?php elseif(($v['order_status']==1 || $v['order_status']==8)): ?>
<!--                                                    <li>未发货</li>-->
<!--                                                    <li><a>退货/退款</a></li>-->
