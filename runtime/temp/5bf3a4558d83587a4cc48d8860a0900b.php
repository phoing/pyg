<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\heima\server\pyg\public/../application/home\view\live\create.html";i:1576394168;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;s:59:"E:\heima\server\pyg\application\home\view\member_lefts.html";i:1576393773;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="yui3-u-5-6">
                <div class="body userAddress">
                    ...
                    <div class="address-detail">
                        <form action="<?php echo url('save'); ?>" method="post" class="sui-form form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" onfocus="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })" id="datemin" class="input-text input-large Wdate" style="" name="start_time" value="">
                                </div>
                            </div>
                            <div class="control-group">
