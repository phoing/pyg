<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\heima\server\pyg\public/../application/home\view\live\read.html";i:1576395161;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;s:59:"E:\heima\server\pyg\application\home\view\member_lefts.html";i:1576393773;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="yui3-u-5-6">
                <div class="body">
                    <div class="order-detail">
                        <h4>直播详情:<?php echo $info['title']; ?></h4>
                        <div class="order-bar">
                        ...
                        <div class="order-state">
                            ...
                            <p>开始时间：<span class="red"><?php echo $info['start_time']; ?></span></p>
                        </div>
                    </div>
                    <div class="order-info">
                        <h5>直播信息</h5>
                        <p>推流地址：<?php echo $info['push_url']; ?></p>
                        <p>推流密钥：<?php echo $info['push_key']; ?></p>
                        <p>播流地址：<?php echo $info['live_url']; ?></p>
                    </div>
