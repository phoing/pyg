<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"E:\heima\server\pyg\public/../application/admin\view\brand\product-brand.html";i:1563080270;s:61:"E:\heima\server\pyg\application\admin\view\layout\layout.html";i:1557468795;s:60:"E:\heima\server\pyg\application\admin\view\layout\_meta.html";i:1557469360;s:62:"E:\heima\server\pyg\application\admin\view\layout\_footer.html";i:1557469363;s:62:"E:\heima\server\pyg\application\admin\view\layout\_header.html";i:1559719521;s:60:"E:\heima\server\pyg\application\admin\view\layout\_menu.html";i:1559037674;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<article class="cl pd-20">
			<div class="text-c">
				<form class="Huiform" method="get" action="<?php echo url('index'); ?>" target="_self">
					<input type="text" placeholder="品牌名称" name="keyword" value="<?php echo \think\Request::instance()->param('keyword'); ?>" class="input-text" style="width:120px">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
					...
					<a href="javascript:;" data-url="<?php echo url('create'); ?>" id="add" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加品牌</a>
				</span>
				...
				<table class="table table-border table-bordered table-bg table-sort">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td><?php echo $v['id']; ?></td>
							<td><input type="text" class="input-text text-c" value="<?php echo $v['sort']; ?>"></td>
							<td><img src="<?php echo $v['logo']; ?>" width="100px"></td>
							<td class="text-l"><?php echo $v['name']; ?></td>
							<td class="text-l"><?php echo $v['cate_name']; ?></td>
