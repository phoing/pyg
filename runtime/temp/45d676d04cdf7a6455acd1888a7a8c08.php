<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\heima\server\pyg\public/../application/home\view\login\login.html";i:1576376369;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
	<div class="login-box">
		...
		<div class="py-container logoArea">
			<a href="<?php echo url('home/index/index'); ?>" class="logo"></a>
		</div>
		<!--loginArea-->
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('home/login/dologin'); ?>" method="post">
          ...
          自动登录
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger" id="login-btn" href="javascript:void(0)">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										...
										<li><a href="/plugins/alipay/oauth/index.php"><img src="/static/home/img/ali.png" /></a></li>
