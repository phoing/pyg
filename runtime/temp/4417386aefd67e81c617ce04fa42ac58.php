<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\heima\server\pyg\public/../application/home\view\cart\index.html";i:1575882774;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
								<li class="yui3-u-1-24">
									<input type="checkbox" class="row_check" name="" id="" value="" <?php if(($v['is_selected'])): ?>checked<?php endif; ?> />
								</li>
