<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\heima\server\pyg\public/../application/home\view\order\create.html";i:1575891857;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
				...
				<div class="step-cont">
					<div class="addressInfo">
						<ul class="addr-detail">
							...
							<li class="addr-item" address_id="<?php echo $v['id']; ?>">
								<div class="con name <?php if(($v['is_default'])): ?>selected<?php endif; ?>"><a href="javascript:;" ><em><?php echo $v['consignee']; ?></em><span title="点击取消选择">&nbsp;</span></a></div>
						...
						<ul class="send-detail">
							<li>
								...
								<div class="sendGoods">
									...
									<ul class="yui3-g">
										<li class="yui3-u-1-6">
											<span><img src="<?php echo $v['goods']['goods_logo']; ?>"/></span>
										</li>
										<li class="yui3-u-7-12">
											<div class="desc"><?php echo $v['goods']['goods_name']; ?> <?php echo $v['spec_goods']['value_names']; ?></div>
											<div class="seven">7天无理由退货</div>
										</li>
										<li class="yui3-u-1-12">
											<div class="price">￥<?php echo $v['goods']['goods_price']; ?></div>
										</li>
										<li class="yui3-u-1-12">
											<div class="num">X<?php echo $v['number']; ?></div>
										</li>
										<li class="yui3-u-1-12">
											<div class="exit"><?php if(($v['goods']['goods_number'] > $v['number'])): ?>有货<?php else: ?>无货<?php endif; ?></div>
										</li>
									</ul>
									<?php endforeach; ?>
								</div>
	...
	<script>
		$(function () {
			function default_address(element){
				var consignee = element.closest('li').find('.consignee_name').html();
				var address = element.closest('li').find('.consignee_address').html();
				var phone = element.closest('li').find('.consignee_phone').html();

				$('.fc-receiverInfo').html('寄送至:' + address + ' 收货人；' + consignee + ' ' + phone);
			}
			var selected = $('.addressInfo').find('.selected');
		...
		//	提交订单
			$('.submit').click(function () {
				var address_id = $('.addressInfo').find('.selected').parent('li').attr('address_id');
