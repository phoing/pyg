<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\heima\server\pyg\public/../application/home\view\goods\detail.html";i:1575804621;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<?php if((isset($goods['goods_images'][0]))): ?>
							<span class="jqzoom"><img jqimg="<?php echo $goods['goods_images'][0]['pics_big']; ?>" src="<?php echo $goods['goods_images'][0]['pics_sma']; ?>" /></span>
							<?php else: ?>
							<span class="jqzoom"><img jqimg="" src="" /></span>
							<?php endif; ?>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								<dt>
									<div class="fl title">
										<i><?php echo $spec['spec_name']; ?></i>
									</div>
								</dt>
								<dd>
									<?php foreach($spec['spec_values'] as $k=>$v): ?>
									<a href="javascript:;" value_id="<?php echo $v['id']; ?>" class="<?php if(($k==0)): ?>selected<?php endif; ?>"><?php echo $v['spec_value']; ?><span title="点击取消选择">&nbsp;</span></a>
									<?php endforeach; ?>
								</dd>
							</dl>
							<?php endforeach; ?>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<?php foreach($goods['goods_attr'] as $v): ?>
										...
										<div class="content">
											<div class="com-item">
												<div class="user-column">
													<div class="username"><img src="/static/home/img/_/photo.jpg"/>用户****1</div>
	...
	<script>
		var value_ids_map = <?php echo $value_ids_map; ?>;
		$(function(){
			// 加入购物车
			$('#addshopcar').click(function () {
				...
				$('.selected').each(function (i,v) {
					value_ids += $(v).attr('value_id') + '_';
				});
				value_ids = value_ids.slice(0,-1);

				var spec_goods_id = '';
				if(value_ids_map[value_ids]){
					spec_goods_id = value_ids_map[value_ids].id;
				}
			...
			$('#specification').find('a').click(function(){
				...
				value_ids = value_ids.slice(0,-1);
				var price = value_ids_map[value_ids] ? value_ids_map[value_ids].price : 0;
				if(price){
