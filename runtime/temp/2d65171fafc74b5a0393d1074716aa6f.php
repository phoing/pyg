<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\heima\server\pyg\public/../application/home\view\member\address.html";i:1576293548;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;s:58:"E:\heima\server\pyg\application\home\view\member_left.html";i:1576327474;}*/ ?>
<!DOCTYPE html>
<html>
                            ...
                            <table class="sui-table table-bordered">
                                ...
                                <?php foreach($list as $v): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="modal" data-target="#editModal" class="edit" data-keyboard="false" onclick="eidtAddress(<?php echo $v['id']; ?>)">编辑</a>
                                            <a href="<?php echo url('home/member/delAddress',['id'=>$v['id']]); ?>" onclick="if(!confirm('确定是否删除！？')){return false;}">删除</a>
                                            <?php if(($v['is_default']==1)): ?>
                                            默认地址
                                            <?php else: ?>
                                            <a href="<?php echo url('home/member/setDefault',['id'=>$v['id']]); ?>">设为默认</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
...
function eidtAddress(id){
    $.ajax({
        url:'<?php echo url("home/member/getAddress"); ?>',
        type:'post',
        data:'id=' + id,
        dataType:'json',
...
$("#editAddressButton").click(function () {
    ...
    $.ajax({
        url:'<?php echo url("home/member/editAddress"); ?>',
        type:'post',
        data:data,
        dataType:'json',
        success:function(res){
...
$("#addAddressButton").click(function () {
    ...
    $.ajax({
        url:'<?php echo url("home/member/addAddress"); ?>',
        type:'post',
        data:data,
        dataType:'json',
        success:function(res){
