<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\heima\server\pyg\public/../application/home\view\member\orderDetail.html";i:1576321269;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576325705;s:58:"E:\heima\server\pyg\application\home\view\member_left.html";i:1576327474;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="yui3-u-5-6">
                    <div class="body">
                                ...
                                <div class="sui-steps-round steps-round-auto steps-4">
                                    <div class="finished">
                                        ...
                                        <label>
                                            ...
                                            <span><?php echo date('H:i:s',$list['create_time']); ?></span>
                                        </label>
                                    </div>
                                    <div class="<?php if(($list['order_status']>0)): ?>current<?php else: ?>todo<?php endif; ?>">
                                        <div class="wrap">
                                        ...
                                        <label>
                                            <span>付款成功</span>
                                            <span><?php if((!empty($list['pay_time']))): ?><?php echo date('Y-m-d',$list['pay_time']); endif; ?></span>
                                            <span><?php if((!empty($list['pay_time']))): ?><?php echo date('Y-m-d',$list['pay_time']); endif; ?></span>
                                        </label>
                                    </div>
                                    <div class="<?php if(($list['order_status']>1)): ?>current<?php else: ?>todo<?php endif; ?>">
                                        <div class="wrap">
                                        ...
                                        <label>
                                            <span>发货</span>
                                            <span><?php if((!empty($list['shipping_time']))): ?><?php echo date('Y-m-d',$list['shipping_time']); endif; ?></span>
                                            <span><?php if((!empty($list['shipping_time']))): ?><?php echo date('Y-m-d',$list['shipping_time']); endif; ?></span>
                                        </label>
                                    </div>
                                    <div class="<?php if(($list['order_status']>2)): ?>current<?php else: ?>todo<?php endif; ?>">
                                        <div class="wrap">
                                        ...
                                        <label>
                                            <span>确认收货</span>
                                            <span><?php if((!empty($list['confirm_time']))): ?><?php echo date('Y-m-d',$list['confirm_time']); endif; ?></span>
                                            <span><?php if((!empty($list['confirm_time']))): ?><?php echo date('Y-m-d',$list['confirm_time']); endif; ?></span>
                                        </label>
                                    </div>
                                    
                                    <div class="<?php if(($list['order_status']>2)): ?>current<?php else: ?>todo<?php endif; ?> last">
                                        <div class="wrap">
                        ...
                        <div class="order-info">
                            <h5>订单信息</h5>
                            <p>收货地址：<?php echo $list['address']; ?>  </p>
                            <p>订单单号：<?php echo $list['order_sn']; ?></p>
                            <p>下单时间：<?php echo $list['create_time']; ?></p>
                            <p>支付时间：<?php echo $list['pay_time']; ?></p>
                            <p>支付方式：<?php echo $list['pay_name']; ?></p>
                            <p>发货时间：<?php echo $list['shipping_time']; ?></p>
                        </div>
                        <div class="order-goods">
                            <table class="sui-table">
                                ...
                                <tbody>                               
                                    <tr>
                                        <td colspan="5">订单编号：<?php echo $list['order_sn']; ?></td>
                                    </tr>
									<?php foreach($list['order_goods'] as $v): ?>
                                    <tr>
                                        <td>
                                            <div class="typographic"><img src="<?php echo $v['goods_logo']; ?>" />
                                                    <span>包邮 <?php echo $v['goods_name']; ?> 新款</span>
                                                    <span class="guige">规格：<?php echo $v['spec_value_names']; ?></span>
                                                </div>
                                        </td>
                                        <td>
                                            <ul class="unstyled">
                                                    <li class="o-price">¥<?php echo $v['goods_price']; ?></li>
                                                    <li>¥<?php echo $v['goods_price']; ?></li>
                                                </ul>
                                        </td>
                                        ...
                                        <td>
											...
											<?php elseif(($v['status']==1)): ?>已发货
											<?php elseif(($v['status']==2)): ?>已换货
											<?php elseif(($v['status']==3)): ?>已退货
											<?php endif; ?>
										</td>
                                    </tr>
								<?php endforeach; ?>
                            ...
                            <div class="order-price">
                                <p>商品总金额：￥<?php echo $list['total_amount']; ?></p>
                                <p>运费金额：，免费用</p>
                                <p>使用优惠券：无</p>
                                <h4 class="red">实际支付：￥<?php echo $list['total_amount']; ?></h4>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <!--猜你喜欢-->
