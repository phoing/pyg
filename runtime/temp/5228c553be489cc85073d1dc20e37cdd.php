<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\heima\server\pyg\public/../application/home\view\goods\index.html";i:1576332064;s:53:"E:\heima\server\pyg\application\home\view\layout.html";i:1576376392;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="goods-list">
					<ul class="yui3-g">
						...
						<li class="yui3-u-1-5">
							<div class="list-wrap">
								<div class="p-img">
									<a href="<?php echo url('home/goods/detail',['id'=>$v['id']]); ?>" target="_blank"><img src="<?php echo $v['goods_logo']; ?>" /></a>
								</div>
								<div class="price">
									<strong>
											<em>¥</em>
								...
								<div class="operate">
									...
									<a href="javascript:;" class="sui-btn btn-bordered a" onclick="collectGoods(<?php echo $v['id']; ?>)">关注</a>
								</div>
							</div>
						</li>
						<?php endforeach; ?>
...
<!--      页 <button class="page-confirm" onclick="alert(1)">确定</button></span></div>-->
	...
	<script>
		function collectGoods(id) {
			$.ajax({
				url:'<?php echo url("home/member/addCollect"); ?>',
				type:'post',
				data:'id='+id,
				dataType:'json',
